...
export default function OAuthButton({ provider, fullWidth = true }) {
  const { label, Icon, href, className } = PROVIDERS[provider];
...
// Convenience: render both providers with a divider
